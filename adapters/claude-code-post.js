...
// again". So every question Rockfort Legend raises is a question it will raise again
...
function run(input) {
  ...
  // MCP tools are inventoried rather than judged. Rockfort Legend cannot see inside
