...
echo
HOME="$SB/home" node bin/vg.js skills pin --all --cwd "$SB/proj"
echo
...
echo
HOME="$SB/home" node bin/vg.js skills pin clean-formatter --accept-risk --cwd "$SB/proj"
echo
