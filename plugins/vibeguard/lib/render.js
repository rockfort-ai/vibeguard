...
function claudeCode(policy, { scope = 'user', hookPath, sessionHookPath } = {}) {
  ...
  if (hookPath || sessionHookPath) out.hooks = {};
  if (hookPath) {
...
function cursorHooks(policy, { hookPath = './.vibeguard/adapters/cursor.js' } = {}) {
...
function codexConfig(policy) {
  ...
  const deny = domainsFor(policy, 'deny');
  const lines = [
    '# Generated by vibeguard — do not edit by hand. Run `vg sync --target codex`.',
    '',
...
function squidConf(policy) {
  ...
  return [
    '# Generated by vibeguard — run `vg sync --target proxy`.',
