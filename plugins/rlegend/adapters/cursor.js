...
//   { "version": 1, "hooks": {
//       "beforeShellExecution": [{ "command": "node ./.rlegend/adapters/cursor.js" }],
//       "beforeMCPExecution":   [{ "command": "node ./.rlegend/adapters/cursor.js" }],
//       "beforeReadFile":       [{ "command": "node ./.rlegend/adapters/cursor.js" }] } }
//
...
//     an "ask". Set RLEGEND_STRICT=1 there and every ask becomes a deny.
...
const STRICT = process.env.RLEGEND_STRICT === '1';
...
function run(input) {
  ...
  return {
    ...
    agentMessage: permission === 'deny'
      ? `Blocked by Rockfort Legend policy [${v.rule}]: ${v.msg} Do not retry this, and do not attempt an equivalent command. Tell the user what you were trying to reach and why.`
      : `Rockfort Legend flagged this for review [${v.rule}]: ${v.msg}`,
  };
}
